    ...
    return (
        <div className="w-1/4 h-full bg-gray-800 text-white p-4 flex flex-col">
            <button
                ...
                className="rounded-lg mb-3 py-2 bg-cyan-400 hover:bg-cyan-600"
            >
                New Chat
            </button>
                ...
                <ul className="max-h-96 overflow-y-auto">
                    {chatMessages.map((message, index) => (
                        <li
                            ...
                            key={index}
                            className="mb-2 p-2 bg-gray-700 rounded-lg cursor-pointer"
                        >
                            Chat {index + 1}
                        </li>
                    ))}
            ...
            <div className="mt-auto">
                {!isAuthenticated ? (
                    <div>
                        <button
                            onClick={login}
                            className="w-full bg-green-500 py-2 rounded-lg mb-4"
                        >
                            Login
                        </button>
                        <button
                    ...
                    <button
                        onClick={logout}
                        className="bg-gray-500 w-full py-2 rounded-lg"
                    >
                        Logout
                    </button>
                )}
